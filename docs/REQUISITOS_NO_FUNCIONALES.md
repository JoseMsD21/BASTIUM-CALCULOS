...
|---|---|---|
| **Plataforma** | Windows, macOS, Linux con Python 3.14 instalado. | Sin dependencias nativas fuera de `requirements.txt` (PySide6, SQLAlchemy, reportlab, python-docx, matplotlib, holidays). |
