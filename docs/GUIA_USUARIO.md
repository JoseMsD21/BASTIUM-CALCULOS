...
> Honorarios/Litigio, Laboral y exportación de liquidaciones a PDF/Word. Cada vez que se complete un
> sprint nuevo de [`Pendientes.md`](../Pendientes.md), esta guía se actualiza para que nunca quede
> desactualizada respecto al programa real.
