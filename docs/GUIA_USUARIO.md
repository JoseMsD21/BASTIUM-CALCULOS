...
> antes que nada.
>
> **Última actualización:** 2026-08-18 — agrega la casilla "Aplica indexación IPC" (y sus reglas propias de
> exclusión/coexistencia) a Comercial, Laboral, Sancionatorio y Honorarios, antes exclusiva de Civil/
> Familia; documenta el nuevo tipo de recurrencia "Fechas anuales fijas" para obligaciones que no se repiten
> mes a mes (ej. gastos de vestuario); y describe el nuevo layout de 2 columnas del formulario "Agregar
> obligación". Anteriormente agregó el paso "Generar cuotas" (obligatorio para que el
